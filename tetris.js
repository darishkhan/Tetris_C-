...
// include: C:\Users\daris\AppData\Local\Temp\tmp7id7q9i3.js
...
Module['FS_createPath']("/", "sounds", true, true);
    ...
    loadPackage({"files": [{"filename": "/font/KnightWarrior.otf", "start": 0, "end": 13676}, {"filename": "/sounds/clearSound.mp3", "start": 13676, "end": 50456, "audio": 1}, {"filename": "/sounds/music.mp3", "start": 50456, "end": 12779517, "audio": 1}, {"filename": "/sounds/rotateSound.wav", "start": 12779517, "end": 13011561, "audio": 1}], "remote_package_size": 13011561});

  })();

// end include: C:\Users\daris\AppData\Local\Temp\tmp7id7q9i3.js
// include: C:\Users\daris\AppData\Local\Temp\tmp9fur4lii.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\daris\AppData\Local\Temp\tmp9fur4lii.js
// include: C:\Users\daris\AppData\Local\Temp\tmp6_cvac89.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\daris\AppData\Local\Temp\tmp6_cvac89.js
...
var ASM_CONSTS = {
 ...
 8453754: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 8453820: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 8454213: ($0) => { miniaudio.untrack_device_by_index($0); },  
 8454256: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 8454381: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
